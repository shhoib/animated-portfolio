...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_p5wg83x', 'template_rgtpyim', formref.current, 'Rq69o_6Rw5lrcQxZA')
      .then((result) => {
    ...
    >
      <motion.div className="textContainer">
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>shuaibsalam1234@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Taliparamba, Kannur, Kerala</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+91 9605155858</span>
        </motion.div>
      </motion.div>
      <div className="formContainer">
        ...
        >
          ...
          <textarea rows={8} placeholder="Message..." name="msg"></textarea>
